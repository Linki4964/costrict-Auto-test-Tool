...
- **扫描时间**: `2025-12-07 20:19:59`
- **耗时**: `17.1 秒`
- **目标地址**: `http://192.168.142.146`
- **源码路径**: `E:\project\Costric\RuoYi-Vue\RuoYi-Vue-master`
- **发现接口数**: `117`
...
| 接口路径 | 完整 URL | 问题说明 |
|----------|----------|----------|
| `/captchaImage` | [http://192.168.142.146/prod-api/captchaImage](http://192.168.142.146/prod-api/captchaImage) | 无 Token 返回成功！; 无效 Token 返回成功！ |
